...
public:
    ...
    * for tree selection events. Event callbacks are static methods, so the
   ...
   /**
    * ClickedX is one of the callbacks for GUI controls. As described above,
