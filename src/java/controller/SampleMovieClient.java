...
/**
 * Purpose: This class provides a controller demonstrating the use
 * of the MovieLibraryGui class.
 * This project provides for browsing and managing information about
...
public class SampleMovieClient extends MovieLibraryGui implements
   ...
   /**
    * Create and initializes nodes in the JTree of the left pane.
    * buildInitialTree is called by MovieLibraryGui to initialize the JTree.
    * Classes that extend MovieLibraryGui override this method to 
   ...
   public static void main(String args[]) {
      try{
         String authorName = (args.length>=1)?args[0]:"Movie Library";
